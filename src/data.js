export const portfolio = {
  ...
  skills: [
    ...
    },
    {
      ...
      items: ['Data Structures & Algorithms (DSA)', 'Object-Oriented Programming']
    },
    {
  ...
  experience: {
    ...
    summary: [
      ...
      'Performed application testing, debugging, and quality assurance to ensure smooth user experience and proper functionality.',
      'Collaborated with development teams to report issues, suggest improvements, and validate feature performance.',
      'Gained hands-on experience in software development lifecycle, app validation, and real-world project workflows.'
    ]
  },
  contact: {
    linkedin: 'https://www.linkedin.com/in/virat-singh-pundir-4b3230251',
    github: 'https://github.com/viratpundir',
    resume: '/resume.pdf',
    email: 'viratsinghpundir123@gmail.com'
  }
};
